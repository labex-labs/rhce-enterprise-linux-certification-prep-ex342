...
<p align="center">
  <a href="https://labex.io/zh/learn/rhce-enterprise-linux">
    <img width="128" src="https://file.labex.io/path/VJAk5cEITuZT.png" alt="RHCE in Enterprise Linux 培训">
  </a>
</p>
...
[在 LabEx 开始学习路径](https://labex.io/zh/learn/rhce-enterprise-linux)

**课程**: 3 · **实验**: 56

## 课程

### 1. [RHCE 企业级 Linux 实战模拟考试 01](https://labex.io/zh/courses/rhce-enterprise-linux-practice-exam-01)
...
|   序号 | 名称                     | 难度   | 练习                                                                                                                                             |
|------|------------------------|------|------------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 收集受损主机的证据              | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-collect-evidence-for-a-degraded-host-664461?course=rhce-enterprise-linux-practice-exam-01)                |
|    2 | 恢复集中式日志记录与 Journal 持久化 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-restore-centralized-logging-and-journal-persistence-664471?course=rhce-enterprise-linux-practice-exam-01) |

#### Startup, Boot, Hardware, and Kernel Issues

|   序号 | 名称                | 难度   | 练习                                                                                                                                                 |
|------|-------------------|------|----------------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 修复启动服务依赖故障        | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-repair-a-failed-boot-service-dependency-664466?course=rhce-enterprise-linux-practice-exam-01)                 |
|    2 | 修复内核或引导配置漂移后的访问权限 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-restore-access-after-kernel-or-boot-configuration-drift-664470?course=rhce-enterprise-linux-practice-exam-01) |

#### File System, LVM, Encryption, and iSCSI Issues

|   序号 | 名称               | 难度   | 练习                                                                                                                                         |
|------|------------------|------|--------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 恢复损坏的文件系统及挂载状态   | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-recover-a-corrupted-file-system-and-mount-state-664465?course=rhce-enterprise-linux-practice-exam-01) |
|    2 | 修复不完整的 LVM 堆栈    | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-repair-an-incomplete-lvm-stack-664467?course=rhce-enterprise-linux-practice-exam-01)                  |
|    3 | 恢复加密的 iSCSI 存储访问 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-restore-encrypted-iscsi-storage-access-664472?course=rhce-enterprise-linux-practice-exam-01)          |

#### Package Management Issues

|   序号 | 名称            | 难度   | 练习                                                                                                                                          |
|------|---------------|------|---------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 解决软件包数据库与依赖故障 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-resolve-package-database-and-dependency-failures-664468?course=rhce-enterprise-linux-practice-exam-01) |

#### Network Connectivity Issues

|   序号 | 名称          | 难度   | 练习                                                                                                                                        |
|------|-------------|------|-------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 恢复网络服务可达性   | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-restore-network-service-reachability-664473?course=rhce-enterprise-linux-practice-exam-01)           |
|    2 | 捕获路由问题的流量证据 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-capture-traffic-evidence-for-a-routing-problem-664460?course=rhce-enterprise-linux-practice-exam-01) |

#### Application, SELinux, and Containerized Application Issues

|   序号 | 名称                  | 难度   | 练习                                                                                                                                           |
|------|---------------------|------|----------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 修复应用程序依赖与运行时故障      | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-fix-an-application-dependency-and-runtime-failure-664462?course=rhce-enterprise-linux-practice-exam-01) |
|    2 | 解决 SELinux 与容器化服务故障 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-resolve-selinux-and-containerized-service-failure-664469?course=rhce-enterprise-linux-practice-exam-01) |

#### Authentication and Identity Issues

|   序号 | 名称          | 难度   | 练习                                                                                                                 |
|------|-------------|------|--------------------------------------------------------------------------------------------------------------------|
|    1 | 修复 PAM 登录失败 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-fix-a-pam-login-failure-664463?course=rhce-enterprise-linux-practice-exam-01) |

#### Crash, SystemTap, and Third-Party Investigation Data

|   序号 | 名称                   | 难度   | 练习                                                                                                                                       |
|------|----------------------|------|------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 收集崩溃与 SystemTap 调查数据 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-gather-crash-and-systemtap-investigation-data-664464?course=rhce-enterprise-linux-practice-exam-01) |

### 2. [RHCE 企业级 Linux 实战模拟考试 02](https://labex.io/zh/courses/rhce-enterprise-linux-practice-exam-02)
...
|   序号 | 名称          | 难度   | 练习                                                                                                                                        |
|------|-------------|------|-------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 为重复性故障构建支持包 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-build-a-support-bundle-for-a-recurring-failure-664474?course=rhce-enterprise-linux-practice-exam-02) |
|    2 | 配置带日志的诊断收集  | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-configure-diagnostic-collection-with-logging-664475?course=rhce-enterprise-linux-practice-exam-02)   |

#### Startup, Boot, Hardware, and Kernel Issues

|   序号 | 名称              | 难度   | 练习                                                                                                                                         |
|------|-----------------|------|--------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 恢复陷入紧急模式的系统     | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-restore-a-system-stuck-in-emergency-mode-664487?course=rhce-enterprise-linux-practice-exam-02)        |
|    2 | 修复引导加载程序参数与设备故障 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-repair-bootloader-arguments-and-device-symptoms-664481?course=rhce-enterprise-linux-practice-exam-02) |

#### File System, LVM, Encryption, and iSCSI Issues

|   序号 | 名称                   | 难度   | 练习                                                                                                                                                |
|------|----------------------|------|---------------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 修复损坏的逻辑卷挂载           | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-repair-a-broken-logical-volume-mount-664482?course=rhce-enterprise-linux-practice-exam-02)                   |
|    2 | 恢复配置错误的加密挂载数据        | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-recover-data-from-a-misconfigured-encrypted-mount-664480?course=rhce-enterprise-linux-practice-exam-02)      |
|    3 | 在容量故障后恢复持久化 iSCSI 存储 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-restore-persistent-iscsi-storage-after-capacity-outage-664485?course=rhce-enterprise-linux-practice-exam-02) |

#### Package Management Issues

|   序号 | 名称         | 难度   | 练习                                                                                                                            |
|------|------------|------|-------------------------------------------------------------------------------------------------------------------------------|
|    1 | 修复失败的软件包事务 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-repair-failed-package-transactions-664483?course=rhce-enterprise-linux-practice-exam-02) |

#### Network Connectivity Issues

|   序号 | 名称                      | 难度   | 练习                                                                                                                                        |
|------|-------------------------|------|-------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 修复损坏的 NetworkManager 路由 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-fix-a-broken-networkmanager-route-664479?course=rhce-enterprise-linux-practice-exam-02)              |
|    2 | 诊断防火墙与服务绑定冲突            | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-diagnose-firewall-and-service-binding-conflict-664478?course=rhce-enterprise-linux-practice-exam-02) |

#### Application, SELinux, and Containerized Application Issues

|   序号 | 名称                         | 难度   | 练习                                                                                                                                           |
|------|----------------------------|------|----------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 调试崩溃的应用程序进程                | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-debug-a-crashing-application-process-664477?course=rhce-enterprise-linux-practice-exam-02)              |
|    2 | 恢复带有 SELinux 约束的 Podman 服务 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-restore-a-podman-service-with-selinux-constraints-664486?course=rhce-enterprise-linux-practice-exam-02) |

#### Authentication and Identity Issues

|   序号 | 名称          | 难度   | 练习                                                                                                                                   |
|------|-------------|------|--------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 修复身份查找与登录行为 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-repair-identity-lookup-and-login-behavior-664484?course=rhce-enterprise-linux-practice-exam-02) |

#### Crash, SystemTap, and Third-Party Investigation Data

|   序号 | 名称                   | 难度   | 练习                                                                                                                                  |
|------|----------------------|------|-------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 创建安全的 SystemTap 诊断探针 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-create-a-safe-systemtap-diagnostic-probe-664476?course=rhce-enterprise-linux-practice-exam-02) |

### 3. [RHCE 企业级 Linux 备考指南 (EX342)](https://labex.io/zh/courses/rhce-enterprise-linux-prep)
